...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            if insect.name == 'Queen' and insect.is_first:
                return
            # END Problem 13
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        i = 0
        cur = self.place
        while cur and cur is not beehive:
            if self.min_range <= i and self.max_range >= i and cur.bees:
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        if self.is_first:
            ...
            cur = self.place.exit
            while cur:
                if cur.ant and cur.ant not in self.ants:
                    self.ants.append(cur.ant)
                    cur.ant.damage *= 2
                if cur.ant and cur.ant.is_container and cur.ant.contained_ant and cur.ant.contained_ant not in self.ants:
                    self.ants.append(cur.ant.contained_ant)
    ...
    def effect(duration):
        def new_action(colony):
            ...
            if duration < 1:
                ...
                action(colony) if (colony.time % 2 == 0) else None
            duration -= 1
        return new_action
    return effect
    # END Problem EC
